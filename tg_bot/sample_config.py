...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "932430304:AAF-dgMhtqRycxjVnv753vhydcfOPVxBkmU"
    OWNER_ID = "266400398"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "coccrhard"
